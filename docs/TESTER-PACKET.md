...
The current target is the v2.2.0 experience on Windows. Please record the exact edition and version you used; Block Lite, Block, and Block+ may have different capabilities.
